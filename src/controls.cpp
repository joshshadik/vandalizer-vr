...
void Controls::setVRController(int index, const glm::vec3& position, const glm::quat& orientation)
{
...
const Controls::VRController& Controls::getVRController(int index)
{
    return _vrControllers[index];
}